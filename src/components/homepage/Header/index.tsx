...
const Header = () => {
  return (
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden relative">
      <div className="md:max-w-framemx-auto md:pl-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 ">
        <section className="max-w-frame px-4">
          ...
          >
           FIND A SCENT THAT DEFINES YOUR VIBE.
          </motion.h2>
          <motion.p
          ...
          >
            Explore our curated collection of unique fragrances, crafted to express your personality and elevate your everyday aura.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
    ...
    <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/header-homepage.png')] md:bg-[url('/images/header-homepage.png')]"
        >
          <Image
            priority
