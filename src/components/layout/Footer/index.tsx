...
import { FaFacebookF, FaGithub, FaInstagram, FaLinkedin, FaMailchimp, FaTwitter } from "react-icons/fa";
...
const socialsData: SocialNetworks[] = [
  {
    id: 1,
    icon: <FaTwitter />,
    url: "https://x.com/xtore.store",
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://facebook.com/xtore.store",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://instagram.com/xtore.store",
  },
  {
    id: 3,
    icon: <FaLinkedin />,
    url: "https://www.linkedin.com/in/xtore-store",
  },
  {
    id: 3,
    icon: <IoMdMail />,
    url: "mailto:info@xtore.store",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          <nav className="lg:grid lg:grid-cols-12 mb-8">
            <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
              ...
              >
                <Image src={"/images/logo/2_black.png"} alt="logo" className=" w-[150px]md:w-full h-auto"  width={100} height={100} />
              </h1>
              <p className="text-black/60 text-sm mb-9">
              We offer fragrances that match your personality and leave a lasting impression — for both men and women.
              </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              xtore. © Made by  {" "}
              <Link
                href="https://github.com/just-abdullah-dev"
